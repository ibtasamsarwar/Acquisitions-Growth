...
const services = [
  ["01", "search", "SEO", "Organic capture systems that own the first page and compound over time."],
  ["02", "code", "Web Dev", "Conversion-first builds engineered purely for revenue."],
  ["03", "share", "SMM", "Social leverage loops that multiply your audience daily."],
  ["04", "ads_click", "Google Ads", "High-intent targeting that finds buyers, not browsers."],
  ["05", "location_on", "Google Business Profile (GBP)", "Local presence optimized to win map pack visibility and inbound leads."]
];

const faqs = [
  ["How fast can we see results?", "Lead generation improvements typically surface within 30 days of deployment. SEO compounds over 90 days."],
  ["Do you work with startups?", "Yes. We partner with ambitious startups and established companies when a clear growth path exists."],
  ["What is the minimum investment?", "Scope depends on the growth system required. We recommend a focused engagement aligned to your current stage."],
  ["What makes your approach different?", "We build interconnected growth systems, not siloed campaigns. Every channel we activate feeds and amplifies the others."]
];
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="hero-wrap" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "flex-end", paddingBottom: "5rem", paddingTop: "7rem", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem", width: "100%", position: "relative", zIndex: 1 }}>
          <h1 className="fu d1 hero-h" style={{ fontFamily: "'Anton', sans-serif", fontSize: "clamp(4.8rem,15vw,16.8rem)", lineHeight: 0.84, letterSpacing: "-3px", textTransform: "uppercase" }}>Scale<br />Your<br /><span style={{ WebkitTextStroke: "3px #1a1a1a", color: "transparent" }}>Business.</span></h1>
          <div className="fu d2 hero-aux" style={{ display: "flex", alignItems: "flex-start", gap: "3rem", marginTop: "2.25rem", flexWrap: "wrap" }}>
            <div style={{ maxWidth: 420 }}>
              <p style={{ fontSize: "1.05rem", color: "#555", lineHeight: 1.7, marginBottom: "1.75rem" }}>The high-performance engine for acquisitions and exponential growth. We deploy high-velocity systems that transform traffic into enterprise value.</p>
              <div className="hero-actions" style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
                <Link className="ctabtn" style={{ fontSize: "1rem", padding: "1rem 2.25rem" }} to="/contact">Book Free Consultation</Link>
                <button className="ctaout" style={{ fontSize: "1rem", padding: "1rem 2.25rem" }} onClick={() => scrollTo("case-studies")}>View Results</button>
              </div>
            </div>
            <div style={{ display: "flex", gap: "2rem", flexWrap: "wrap", paddingTop: "0.25rem" }}>
              {[["Trusted By", "200+ Clients"], ["Experience", "10+ Years"], ["Focus", "ROI-First"]].map(([label, value]) => <div key={label}><div style={{ fontSize: "0.65rem", letterSpacing: "3px", textTransform: "uppercase", color: "#aaa", marginBottom: "0.25rem" }}>{label}</div><div style={{ fontFamily: "'Anton', sans-serif", fontSize: "1.25rem", letterSpacing: "1px" }}>{value}</div></div>)}
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" style={{ padding: "8rem 2rem", background: "#f5f4f0" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "4rem", gap: "2rem", flexWrap: "wrap" }}>
            ...
            <p style={{ maxWidth: 360, color: "#666", fontSize: "1rem", lineHeight: 1.65 }}>Our services are interconnected systems, not siloed campaigns, designed to maximize your acquisition value.</p>
          </div>
      ...
      <section id="case-studies" style={{ padding: "8rem 2rem", background: "#fff" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div className="case-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
            {[{ img: "https://lh3.googleusercontent.com/aida-public/AB6AXuB5RVOC2kyZxd8ILHOfRJmBM8p3iq0gBk6iuNMetF_NTSlxmBvvw4p0O_M3WyDy0nIEm8dFHuYjY6niifhnhur0httQUiCKSYvNE4LTvYD7S0LBWI8tDyyjLFGD1nmJS_QOFPgFtmdDgDggNGszOjUYyGjlxdulDUiSRpzylAVgzCf9jE5nW4f5uR0z-PnySrWolg5Y9OFdLLXq3vspmjPft51ApA4ktoHUfZtaImR6Q3YwEgET7l-gS00240TTnmNtPf4yNeKW4rn4", metric: "+300%", label: "Lead Volume Increase", desc: "Tech SaaS client achieved record organic acquisition within 6 months of deployment.", quote: "The ROI was immediate and sustained.", tags: ["SEO", "CRO", "Content"], timeline: "6 Months" }, { img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBxL-v45YH9-76bkotHtToCzJSED3n8aI4DeVrrFO4_LTDqlv1dGWBdTmHX0xx-6z4CyWrTIulGdFPjcgBTnQ2OLqL35lKMLyYW3AVYzQ1xU0QGA1OZTPqtrV_auItWkFN72ckdsuso5bN9QaaOrropsmAD7cqmficSj5rZk9u71EGZwDXyFemme0Ep-MlskFEnGlpQvI8Jw3pzipr_J36OYxqq4gRaSIhp0OHnbfaAP1r3BQvhe9Q-LyeMNVLJij2gWHGPpLb43sSs", metric: "10x", label: "Direct Ad ROI", desc: "Retail acquisition overhaul led to a complete pivot in customer acquisition cost.", quote: "Changed how we value our acquisitions.", tags: ["Paid Media", "Landing Pages", "Analytics"], timeline: "90 Days" }].map((item) => <article className="case-card" key={item.metric}><div style={{ height: 220, overflow: "hidden" }}><img src={item.img} alt="Case study" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} /></div><div style={{ padding: "2rem" }}><div style={{ display: "flex", justifyContent: "space-between", gap: "1rem", marginBottom: "1rem", flexWrap: "wrap" }}><div style={{ fontSize: "0.68rem", letterSpacing: "3px", textTransform: "uppercase", color: "#aaa" }}>{item.label}</div><div style={{ fontSize: "0.68rem", letterSpacing: "3px", textTransform: "uppercase", color: "#aaa" }}>{item.timeline}</div></div><div style={{ fontFamily: "'Anton', sans-serif", fontSize: "4rem", lineHeight: 1, marginBottom: "0.35rem" }}>{item.metric}</div><p style={{ color: "#555", fontSize: "0.92rem", lineHeight: 1.65, marginBottom: "1.25rem" }}>{item.desc}</p><div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap", marginBottom: "1.25rem" }}>{item.tags.map((tag) => <span key={tag} style={{ border: "1.5px solid #e8e8e4", padding: "0.35rem 0.7rem", fontSize: "0.7rem", letterSpacing: "2px", textTransform: "uppercase", color: "#777", borderRadius: 2 }}>{tag}</span>)}</div><div style={{ borderLeft: "3px solid #1a1a1a", paddingLeft: "1rem" }}><em style={{ color: "#888", fontSize: "0.875rem" }}>&quot;{item.quote}&quot;</em></div></div></article>)}
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "#1a1a1a", padding: "8rem 2rem", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 800, margin: "0 auto" }}>
          ...
          <p className="cta-copy" style={{ color: "#666", fontSize: "1.1rem", maxWidth: 500, margin: "0 auto 2.5rem", lineHeight: 1.65 }}>Stop guessing. Deploy the systems used by top-tier growth agencies to accelerate your business today.</p>
