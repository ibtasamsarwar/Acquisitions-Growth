...
const services = [
  [
    ...
    "Your customers are searching. We make sure your business is what they find."
  ],
  [
    "02",
    "code",
    "Website Development",
    "We create high-performance websites that make a strong impression and drive real business results."
  ],
  [
    "03",
    "share",
    "Social Media Marketing (SMM)",
    "We manage your social media presence, growing your audience and generating a consistent stream of quality leads."
  ],
  [
    "04",
    "ads_click",
    "Google Ads Management",
    "We create and manage targeted ad campaigns that reach high-intent audiences; so your budget works harder and your results speak for themselves."
  ],
  [
    "05",
    "location_on",
    "Google Business Profile Optimization (GBP)",
    "Local visibility, real resuts. We optimize your Google Business Profile so the right customers find you first - and choose you."
  ]
];
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 2rem", width: "100%", position: "relative", zIndex: 1 }}>
          ...
          <div className="fu d2 hero-aux" style={{ display: "flex", alignItems: "flex-start", gap: "2.5rem", marginTop: "1.75rem", flexWrap: "wrap" }}>
            <div style={{ maxWidth: 420 }}>
              <p style={{ fontSize: "1.05rem", color: "#555", lineHeight: 1.7, marginBottom: "1.75rem" }}>Get founded by more customers, faster. We help businesses show up where it matters most - on Google, social media and beyond. More visibility, more clicks, more customers.</p>
      ...
      <section id="case-studies" style={{ padding: "8rem 2rem", background: "#fff" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "3rem", flexWrap: "wrap", gap: "1rem" }}>
            ...
            <Link className="ctaout" to="/case-study-gbp">Case Study</Link>
          </div>
